...
var Bar = React.createClass({
  propTypes: {
    ...
    borderStyle: React.PropTypes.oneOf(['solid', 'dotted', 'dashed']),
...
var BarCluster = React.createClass({
  propTypes: {
    ...
    borderStyle: React.PropTypes.oneOf(['solid', 'dotted', 'dashed']),
    borderWidth: React.PropTypes.number,
    data: React.PropTypes.arrayOf(DataPropType).isRequired,
  ...
  _renderBar: function(datum, index, data) {
    ...
    var antiRatio = 1 - ratio - negRatio;
    var negBar = (
      <AntiBar key='negBar'
        ratio={negRatio}
      />
    ...
    var vertical = this.props.orientation != 'horizontal';
    var barContent = vertical ? [antiBar, bar, negBar] : [negBar, bar, antiBar];
    var marginStyle = {
...
var BarChart = React.createClass({
  propTypes: {
    ...
    clusterSpacing: React.PropTypes.number,
    ...
    displayMode: React.PropTypes.oneOf(['clustered', 'stacked']),
