...
class Axes extends Component {
  ...
  _processProps = (props) => {
    ...
    if (vertical) {
      ...
      this.xAxisStyle = StyleSheet.flatten([styles.categoryAxis, this.props.categoryAxisStyle]);
      this.yAxisStyle = StyleSheet.flatten([styles.valueAxis, this.props.valueAxisStyle]);
      this.xAxisLabelStyle = StyleSheet.flatten([styles.categoryLabel, this.props.categoryLabelStyle]);
      this.yAxisLabelStyle = StyleSheet.flatten([styles.valueLabel, this.props.valueLabelStyle]);
      ...
      this.yAxisStyle = StyleSheet.flatten([styles.categoryAxis, this.props.categoryAxisStyle]);
      this.xAxisStyle = StyleSheet.flatten([styles.valueAxis, this.props.valueAxisStyle]);
      this.yAxisLabelStyle = StyleSheet.flatten([styles.categoryLabel, this.props.categoryLabelStyle]);
      this.xAxisLabelStyle = StyleSheet.flatten([styles.valueLabel, this.props.valueLabelStyle]);
