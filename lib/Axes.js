...
var Axes = React.createClass({
  propTypes: {
    ...
    showCategoryAxisLine: React.PropTypes.bool,
    showCategoryLabels: React.PropTypes.bool,
    showCategoryTicks: React.PropTypes.bool,
    showCategoryGridlines: React.PropTypes.bool,
    ...
    categoryLabels: React.PropTypes.arrayOf(React.PropTypes.string),

    // Value axis options
    showValueAxisLine: React.PropTypes.bool,
    showValueLabels: React.PropTypes.bool,
    showValueTicks: React.PropTypes.bool,
    showValueGridlines: React.PropTypes.bool,
    ...
    valueLabelsFormatter: React.PropTypes.func,
  ...
  _processProps: function(props) {
    ...
    for (var i = 0; i < values.length; i++) {
      var value = values[i];
      var formattedValue = props.valueLabelsFormatter ? props.valueLabelsFormatter(value.toFixed(unitDecimalPlaces)) : value.toFixed(unitDecimalPlaces);
